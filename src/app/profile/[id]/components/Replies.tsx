...
const Replies: FC = () => {
  return (
    <div className="pt-2">
      <ul>
        {[...Array(10)].map((_, i) => (
          <li key={i} className="relative pl-14 w-full border-t border-border pt-4 mt-4 first:border-0 first:pt-0 first:mt-0">
            <Avatar className={clsx('w-10 h-10 absolute left-0 top-0', i === 0 ? 'top-0' : 'top-4')}>
            ...
            <p className="flex flex-col text-xs grow mb-4">
              <span className="text-foreground font-semibold text-sm block">Lorem Ipsum</span>
