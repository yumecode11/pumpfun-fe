...
const CoinsHeld: FC = () => {
  ...
  return (
    <div className="pt-2">
      ...
      <Dialog
        open={showAddContractAddress}
        onOpenChange={setAddContractAddress}
      >
        <DialogContent>
          <DialogHeader>
          ...
          >
            ...
            <p className="text-foreground/80 text-xs text-center">
              if your coin is not listed, you can add it by providing the
              contract address address. only coins launched on pump are
              supported.
            </p>
          </form>
        </DialogContent>
